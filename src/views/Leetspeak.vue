<template>
    <my-page title="火星文" :page="page">
        <textarea class="form-control" v-model="code" rows="6" placeholder="文本"></textarea>
        <div class="btns">
            <ui-raised-button class="btn" primary label="转换火星文" @click="traditionalized" />
            <ui-raised-button class="btn" secondary label="转换简体字" @click="simplized" />
        </div>
        <div v-if="result">
    ...
    export default {
        ...
        methods: {
            ...
            traditionalized() {
                ...
                this.result = traditionalized(this.code)
            },
            simplized() {
                if (!this.code) {
                    alert('请输入文本')
                ...
                this.result = simplized(this.code)
            }
        },
        watch: {
            code() {
