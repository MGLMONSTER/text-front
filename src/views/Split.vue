<template>
    <my-page title="拆字" :page="page">
        <div class="main">
            <ui-text-field class="input" v-model="text" multiLine :rows="3" />
            <div class="btns">
